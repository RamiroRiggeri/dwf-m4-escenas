...
function findAndProcessLinks() {
    ...
    for (const link of els)link.addEventListener("click", (e)=>{
        e.preventDefault();
...
function main() {
    ...
    window.addEventListener("load", ()=>{
        _handleRoute.handleRoute(location.pathname);
    });
}
main(); /*
...
function handleRoute(route) {
    ...
    for (const r of routes)//evalúo si la propiedad path del objeto routes es igual
...
},{}]},["8wcER","h7u1C"], "h7u1C", "parcelRequirefcbc")
